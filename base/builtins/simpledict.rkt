  ...
  (CClass
   ...
   (seq-ops (list 
             (def '$simpledict '__init__
              ...
              (def '$simpledict '__len__
                    (CFunc (list 'self) (none)
                           (CReturn (CBuiltinPrim 'simpledict-len
                                                  (list
                                                   (CId 'self (LocalId)))))
                           true))
              (def '$simpledict '__str__
                   (CFunc (list 'self) (none)
              ...
              (def '$simpledict '__setitem__
                   (CFunc (list 'self 'target 'value) (none)
                          (CSeq
                           (CLet 'loc (LocalId) (CPrim2 'simpledict-find (CId 'self (LocalId)) (CId 'target (LocalId)))
